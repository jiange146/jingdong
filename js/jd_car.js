...
[task_local]
#京东汽车
10 7 * * * https://raw.githubusercontent.com/jiange146/jingdong/master/js/jd_car.js, tag=京东汽车, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_redPacket.png, enabled=true

================Loon==============
[Script]
cron "10 7 * * *" script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/jd_car.js, tag=京东汽车

===============Surge=================
京东汽车 = type=cron,cronexp="10 7 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/jd_car.js

============小火箭=========
京东汽车 = type=cron,script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/jd_car.js, cronexpr="10 7 * * *", timeout=200, enable=true
 */
const $ = new Env('京东汽车');
