...
0 1 * * * https://raw.githubusercontent.com/jiange146/jingdong/master/js/format_share_jd_code.js, tag=获取互助码并格式化/docker自动更新容器下所有账号互助码, img-url=https://raw.githubusercontent.com/yogayyy/task/master/huzhucode.png, enabled=true

================Loon==============
[Script]
cron "0 1 0/2 * *" script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/format_share_jd_code.js, tag=获取互助码并格式化/docker自动更新容器下所有账号互助码

===============Surge=================
获取互助码并格式化/docker自动更新容器下所有账号互助码 = type=cron,cronexp="0 1 * * *",wake-system=1,timeout=120,script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/format_share_jd_code.js

============小火箭=========
获取互助码并格式化/docker自动更新容器下所有账号互助码 = type=cron,script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/format_share_jd_code.js, cronexpr="0 35 2 1,10,20 * ?", timeout=200, enable=true
 */
