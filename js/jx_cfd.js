...
*
    ...
    Quantumult X:
    [task_local]
    0 8-23/2 * * * https://raw.githubusercontent.com/jiange146/jingdong/master/js/jx_cfd.js, tag=京喜财富岛, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true
    [rewrite_local]
    ...
    cron "0 8-23/2 * * *" script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/jx_cfd.js,tag=京喜财富岛
    
    Surge:
    京喜财富岛 = type=cron,cronexp="0 8-23/2 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/jx_cfd.js
    ...
    Shadowrocket:
    [Script]
    京喜财富岛 = type=cron,script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/jx_cfd.js,cronexpr="0 8-23/2 * * *",timeout=120,enable=true
