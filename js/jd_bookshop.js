...
[task_local]
#口袋书店
1 8,12,18 * * * https://raw.githubusercontent.com/jiange146/jingdong/master/js/jd_bookshop.js, tag=口袋书店, enabled=true

================Loon==============
[Script]
cron "1 8,12,18 * * *" script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/jd_bookshop.js,tag=口袋书店

===============Surge=================
口袋书店 = type=cron,cronexp="1 8,12,18 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/jd_bookshop.js

============小火箭=========
口袋书店 = type=cron,script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/jd_bookshop.js, cronexpr="1 8,12,18* * *", timeout=200, enable=true
 */
const $ = new Env('口袋书店');
