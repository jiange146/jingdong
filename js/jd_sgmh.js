...
[task_local]
#闪购盲盒
20 8 * * * https://raw.githubusercontent.com/jiange146/jingdong/master/js/jd_sgmh.js, tag=闪购盲盒, img-url=https://raw.githubusercontent.com/Orz-3/task/master/jd.png, enabled=true
================Loon==============
[Script]
cron "20 8 * * *" script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/jd_sgmh.js, tag=闪购盲盒
===============Surge=================
闪购盲盒 = type=cron,cronexp="20 8 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/jd_sgmh.js
============小火箭=========
闪购盲盒 = type=cron,script-path=https://raw.githubusercontent.com/jiange146/jingdong/master/js/jd_sgmh.js, cronexpr="20 8 * * *", timeout=3600, enable=true
 */
const $ = new Env('闪购盲盒');
